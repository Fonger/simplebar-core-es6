...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('can-use-dom')) :
  typeof define === 'function' && define.amd ? define(['can-use-dom'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.SimpleBar = factory(global.canUseDOM));
}(this, (function (canUseDOM) { 'use strict';
  ...
  class SimpleBar {
    constructor(element, options = {}) {
      ...
      this.onMouseMove = throttle_1(this.onMouseMove, 64);
      this.onWindowResize = debounce_1(this.onWindowResize, 64, {
        leading: true
      });
      this.onStopScrolling = debounce_1(this.onStopScrolling, this.stopScrollDelay);
      this.onMouseEntered = debounce_1(this.onMouseEntered, this.stopScrollDelay);
      this.init();
    }
    /**
     * Static properties
